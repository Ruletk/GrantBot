...
async def get_grant_results(msg: Message, user: User, user_dal: UserDAL, api: Api):
    try:
...
async def info_message_handler(msg: Message, user: User, user_dal: UserDAL, api: Api):
